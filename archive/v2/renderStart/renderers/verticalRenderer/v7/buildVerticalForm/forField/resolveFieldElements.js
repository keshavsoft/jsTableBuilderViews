const resolveFieldElements = ({ inCol, inFootOptions }) => {
    // Check explicit elements array e.g. ["label", "input"], ["label", "input", "button"], ["input", "button"], ["label", "button"]
