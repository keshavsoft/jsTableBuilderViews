export const DEFAULT_CLASSES = {
    ...
    horizontalLabelAligned: {
        ...
        verticalForm: {
            ...
            input: "border border-gray-300 rounded px-3 py-2 w-48 focus:outline-none focus:border-blue-500 text-sm",
            button: "bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2 rounded transition duration-150 cursor-pointer whitespace-nowrap",
            inputGroup: "flex flex-row items-center gap-2 flex-1"
        }
    },
    noLabel: {
        // Without labels
...
export default DEFAULT_CLASSES;
